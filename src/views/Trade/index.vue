  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="order.imgUrl" alt="" style="width: 75px; height: 75px" />
          </li>
          <li>
            <p
              style="
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ defaultInfo.userAddress }}</span>
...
export default {
  ...
  computed: {
    ...
    defaultInfo() {
      return this.addressList.find((items) => items.isDefault == 1) || {};
    },
  },
  methods: {
    changeAddress(address, addressList) {
      addressList.forEach((items) => {
        items.isDefault = 0;
      });
      address.isDefault = 1;
    },
    async submitOrder() {
      ...
      //其余的六个参数
      let data = {
        consignee: this.defaultInfo.consignee, //最终收件人的名字
        consigneeTel: this.defaultInfo.phoneNum, //最终收件人的手机号
        deliveryAddress: this.defaultInfo.fullAddress, //收件人的地址
