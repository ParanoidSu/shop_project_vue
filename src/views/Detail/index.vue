      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  :key="spuSaleAttr.id"
                  @click="changeAttrIsChecked(spuSaleAttr,skuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="clickNum" @keyup="changSkuNum"/>
                <a href="javascript:" class="plus" @click="clickNum++">+</a>
                <a href="javascript:" class="mins" @click="clickNum>1?clickNum--:clickNum=1" >-</a>
              </div>
              <div class="add">
...
export default {
  ...
  mounted() {
    this.$store.dispatch("getGoodInfo", this.$route.params);
  },
  computed: {
    ...mapGetters(["categoryView", "skuInfo", "skuSaleAttrValueList"]),
  },
  methods: {
    changeAttrIsChecked(spuSaleAttr,spuSaleAttrValueList){
    ...
    changSkuNum(event){
      ...
      setTimeout(() => {
        ...
        this.clickNum = parseInt(val)
      }
      }, 1000);
    },
    async addShopcar(){
      try {
        await this.$store.dispatch('AddToCart',{skuId:this.$route.params.skuid,skuNum:this.clickNum})
        sessionStorage.setItem('SKUINFO',JSON.stringify(this.skuInfo))
        this.$router.push({name:'addcartsuccess',query:{skuNum:this.clickNum}})
      } catch (error) {
        alert(error.message)
      }
    }
